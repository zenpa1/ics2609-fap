<!-- Error: Session Expired / Session Error -->
...
<html>
    <head>
        ...
        <link rel="stylesheet" href="<%= request.getContextPath()%>/css/styles.css" /><link rel="stylesheet" href="<%= request.getContextPath()%>/css/styles.css" />
        <title>Error!</title>
    </head>
    <body class="error-body">
        <div>
            ...
            <div class="error-container">
                <h1 class="error-title">Error: Session Expired</h1>
